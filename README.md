...
| **Markups** | Revision clouds, callouts, text notes, highlight boxes — separate layer, never counted; per-markup color + line style; select & delete on canvas; show/hide the whole layer |
