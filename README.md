...
| **Stamps** | Reusable annotation stamps dropped click-to-place as normal markups; browser-wide library (persists across projects) seeded with a flooring shop-drawing set; save your own; export/import as JSON |
