...
| **Markups** | Revision clouds (with △ revision deltas + scalloped in the PDF), callouts, text notes, highlight boxes — separate layer, never counted; per-markup color + line style + line weight; select, drag & delete on canvas; show/hide the whole layer; include/omit in the Marked Set |
