      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", minHeight: 0 }}>
       ...
       <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
        <div ref={containerRef} onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={onPointerUp}
          ...
          {/* zoom buttons — stop pointerdown here: the container's onPointerDown
              setPointerCapture()s every left press, which retargets the pointerup
              and the composed click never reaches these buttons */}
          <div onPointerDown={(e) => e.stopPropagation()} style={{ position: "absolute", left: 14, bottom: 14, display: "flex", flexDirection: "column", gap: 6 }}>
            {[["+", 1.25], ["−", 0.8]].map(([lbl, f]) => (
