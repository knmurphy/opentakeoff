// The OCR evaluation scorer (docs/OCR-EVAL-DOCTRINE.md). Two layers,
...
//     accuracy. finish_tag is the match key on purpose: the scan-import path
//     drops untagged rows (normalizeScanRows, schedule-OCR branch), so a misread
//     tag is a VANISHED row, not a typo.
