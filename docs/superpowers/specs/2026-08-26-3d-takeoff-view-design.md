...
- Editing/assigning ownership (no UI to override a wrong attribution).
- Membership for stitched/multi-sheet rooms (cross-sheet never merges).
- Persisting membership — it derives, it is never stored.
